...
class AskUser extends  Model
{
     ...
     * @return array
     */
    public function selectAskUser($where,$offset=0,$num=1,$field='*',$order='uid desc')
    {
     ...
     */
    public function findAskUser($where,$field='*')
    {
     ...
     * @return mixed
     */
    public function addAskUser($data)
    {
        $this->data($data);
        return $this->save();
    }
     ...
     * @return false|int
     */
    public function saveAskUser($where,$data)
    {
